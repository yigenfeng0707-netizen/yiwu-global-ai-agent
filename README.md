...
```
详见 `docs/演示脚本与录屏指南.md`、`docs/架构设计.md`、`docs/商业计划书.md`、`docs/金义新区落地方案.md`、`docs/路演一页纸.md`、`docs/30秒路演hook.md`、`docs/商户合作意向书_LOI模板.md`、`docs\致金义新区投促局的对接函.md`、`docs\商户内测邀请（一页纸）.md`、`docs/出海诊断报告样例_无线耳机.md`、`docs/答辩落地证据包.md`、`docs/路演PPT大纲.md`、`docs/自评与改进.md`。
