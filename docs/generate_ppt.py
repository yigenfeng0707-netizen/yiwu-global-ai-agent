...
def slide_funding():
    ...
    uses = [
        ('40%', '技术研发', '7大Agent完善 + AI API + 数据对接'),
        ('30%', '市场拓展', '义乌地推驻点 + 39城复制'),
        ('20%', '团队建设', '核心工程师招聘 + 运营/政策'),
        ('10%', '运营储备', '服务器 + 法务 + 应急'),
    ]
    ...
    milestones = [
        ('M1-3', '产品MVP上线，7大Agent核心功能完成', '义乌本地种子用户150+'),
        ('M4-6', '付费用户600+，月收入34万', '启动39城政策复制对接'),
        ('M7-9', '付费用户1,500+，月收入79万', '首批5城政策复制落地'),
        ('M10-12', '月收入152万，累计营收697万，准备Pre-A轮', '39城全面复制启动'),
    ]
